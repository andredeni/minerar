...
echo -e "\033[01;31m━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━═━━═━═━═━═━═━━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━\033[0m"
#-----------------------------------------------------------------------------------------------------------------
echo -ne "\033[1;31m╰━━━━━━━━❪\033[1;36mDIGITE ENTER PRA CONTINUAR (n) SAIR:\033[1;37m"; read x
[[ $x = @(n|N) ]] && exit
echo -e "\033[1;36m SISTEMA DA VPS ?: \033[1;37m"
echo -e "[1] - x86_64"
...
if [[ "$resposta" = '1' ]]; then
    ...
    wget -P $_Ink https://raw.githubusercontent.com/alexdias9421/MASTER/main/Install/list >/dev/null 2>&1
    verif_key
    sleep 3s
    echo "/bin/menu" >/bin/h && chmod +x /bin/h >/dev/null 2>&1
    rm versao* >/dev/null 2>&1
    wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Install/versao >/dev/null 2>&1
    rm v2raymanager >/dev/null 2>&1
    wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/v2raymanager >/dev/null 2>&1
    wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/botteste.sh >/dev/null 2>&1
    chmod 777 v2raymanager >/dev/null 2>&1
    chmod 777 botteste.sh >/dev/null 2>&1
    mkdir $HOME/BOT >/dev/null 2>&1
    cd $HOME/BOT
    wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/ShellBot.sh >/dev/null 2>&1
    chmod 777 ShellBot.sh >/dev/null 2>&1
    cd >/dev/null 2>&1
    #-----------------------------------------------------------------------------------------------------------------
    echo -e "\n\033[1;32mTUDO PRONTO HORA DO SHOW! \033[1;32m"
sleep 2s
    echo ""
    [[ -f "$HOME/usuarios.db" ]] && {
        clear
    ...
    echo -e "\033[1;37m $system                          $date"
    figlet "SSH-PLUS" | lolcat
    echo -e "\033[01;31m║\033[1;31m\033[5;34;47m                 ATUALIZAÇÕES COSTUMA DEMORAR UM POUCO !               \033[1;33m \033[0m\033[01;31m║"
    echo -e "\033[01;31m║\033[0m"
    fun_attlist() {
        apt-get update -y
    ...
    echo -e "\033[1;37m $system                          $date"
    figlet "    SSH-PLUS" | lolcat
    echo -e "\033[01;31m║\033[1;31m\033[5;34;47m                OTIMIZANDO PYTHON               \033[1;33m \033[0m\033[01;31m║"
    echo -e "\033[01;31m║\033[0m"
    ...
    echo 'echo -e "@ALFAINTERNET"' >>.bashrc
    ...
    echo -e "\033[01;31m║\033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@ALFAINTERNET\033[0m"
